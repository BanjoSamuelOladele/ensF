  ...
  return (
    <div className='w-4/12 m-auto rounded-md p-5 bg-green shadow flex flex-col gap-y-2'>
        <form className='flex flex-col gap-y-4 w-9/12 m-auto'>
            <h4 className='bg-gradient-to-r from-green-300 to-pink-500 bg-clip-text text-transparent font-bold text-[20px] text-center'>Register and chat with Freely</h4>
            ...
            <button className='p-2 bg-gradient-to-r from-green-300 to-red-500 rounded-md font-bold text-black' onClick={handleSubmit}>Register</button>
